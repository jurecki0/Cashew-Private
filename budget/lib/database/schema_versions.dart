...
final class Schema47 extends i0.VersionedSchema {
  ...
  late final Shape37 wallets = Shape37(
      source: i0.VersionedTable(
        entityName: 'wallets',
        withoutRowId: false,
        isStrict: false,
...
class Shape37 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get homePageWidgetDisplay =>
      columnsByName['home_page_widget_display']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get walletType =>
      columnsByName['wallet_type']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<String> _column_99(String aliasedName) =>
    i1.GeneratedColumn<String>('wallet_type', aliasedName, true,
        type: i1.DriftSqlType.string,
