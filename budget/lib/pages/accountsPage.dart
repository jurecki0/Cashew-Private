            ...
            child: googleUser == null
                ...
                : Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15), // Space for the new button
                      Padding(
                        padding: const EdgeInsetsDirectional.symmetric(
                            horizontal: 18.0),
                        child: Row(
                          children: [
                            Expanded(
                              child: ConnectBankButton(
                                onTap: () {
                                  // This action is handled in ConnectBankButton
                                },
                              ),
                            ),
                          ],
...
class ConnectBankButton extends StatelessWidget {
  const ConnectBankButton({super.key, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return OutlinedButtonStacked(
      text: "Connect to PKO Bank Polski".tr(),
      iconData: Icons.account_balance,
      onTap: () => _showBankConnectionDialog(context),
    );
  }

  void _showBankConnectionDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
              "Do you want to connect to your bank and associate this connection with your Google account?"),
          actions: [
            TextButton(
              onPressed: () {
  ...
  void _connectToBankAndGoogle() {
    // Add logic here to connect to bank and Google account.
    // This could involve calling APIs or triggering OAuth workflows.
  }
}
